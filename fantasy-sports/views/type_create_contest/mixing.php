...
<?php if($aSports != null && $aPools != null):?>
    <h3><?php echo __('Pick Date', FV_DOMAIN);?></h3>

    <form role="form" class="f-form-inline" id="mixFormCreateContest">
        ...
        <input type="hidden" id="mixingPoolData" value='<?php echo $aMisingPools;?>' />
        ...
        <input type="hidden" name="game_type" value="playerdraft" />
        <select class="form-control" name="listDate" id="listDate" onchange="jQuery.createcontest.mixingLoadFixtures()">
