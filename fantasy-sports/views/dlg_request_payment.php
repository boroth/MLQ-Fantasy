<div id="dlgRequestPayment" style="display: none">
    <form id="formRequestPayment">
        <p>
            <?php echo __('Available balance', FV_DOMAIN);?>: <span class="balance"></span><br/>
            <?php echo __('Rate', FV_DOMAIN);?>: <?php echo get_option('fanvictor_credit_to_cash');?> <?php echo __('withdraw equals', FV_DOMAIN);?> $1
        </p>
        <p>
            <?php echo __('How many credits do you want to withdraw', FV_DOMAIN);?>:<br/>
            <input type="text" name="val[credits]" />
        </p>
        <p>
            <?php echo __('Reason', FV_DOMAIN);?>:<br/>
