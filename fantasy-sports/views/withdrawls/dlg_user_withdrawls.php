<div id="dlgUserWithdrawls" style="display: none">
    ...
    <form id="formUserWithdrawls">
        <table>
            <tr>
                <td style="width: 170px"><?php echo __("Name", FV_DOMAIN);?></td>
                <td class="full_name"></td>
            </tr>
            <tr>
                <td><?php echo __("Amount", FV_DOMAIN);?></td>
                <td class="amount"></td>
            </tr>
            <tr>
                <td><?php echo __("Real Amount", FV_DOMAIN);?></td>
                <td class="real_amount"></td>
            </tr>
            <tr>
                <td><?php echo __("Request Date", FV_DOMAIN);?></td>
                <td class="request_date"></td>
            </tr>
            <tr>
                <td><?php echo __("Reason", FV_DOMAIN);?></td>
                <td class="reason"></td>
            </tr>
        </table>
        <hr>
        <table>
            ...
            <tr>
                <td>
                    <select name="status" class="status">
                        <option value="APPROVED"><?php echo __("APPROVED", FV_DOMAIN);?></option>
                        <option value="DECLINED"><?php echo __("DECLINED", FV_DOMAIN);?></option>
                    </select>
                </td>
            </tr>
            ...
            <?php endif;?>
            <tr>
                <td><?php echo __("Response Message", FV_DOMAIN);?></td>
            </tr>
            <tr>
                <td>
