...
<div class="f-pick-your-team">
    <section data-role="fixture-picker" class="f-fixture-picker">
		...
		<div class="f-fixture-picker-button-container">
            ...
            <a data-team-id1="<?php echo $aFight['fighterID1'];?>" data-team-id2="<?php echo $aFight['fighterID2'];?>" <?php if($aFight['started'] == 0):?>onclick="jQuery.playerdraft.setActiveFixture(this);return jQuery.playerdraft.loadPlayers();"<?php endif;?> class="f-button f-mini fixture-item <?php if($aFight['started'] == 1):?>f-is-disabled<?php endif;?>">
    ...
    <section class="f-contest-player-list-container" data-role="player-list">
        <div class="f-row">
            ...
            <ul class="f-player-list-position-tabs f-tabs f-row">
                ...
                <li>
                    <a href="" data-id="<?php echo $aPosition['id'];?>" onclick="jQuery.playerdraft.setActivePosition(this);return jQuery.playerdraft.loadPlayers();">
                ...
                <div class="f-salary-remaining-container">
                    <span class="f-salary-remaining-amount" id="salaryRemaining">
                        <?php if($aPool['salary_remaining'] > 0):?>
                            $<?php echo number_format($aPool['salary_remaining']);?>
                        <?php else:?>
            ...
            <ul>
                <?php if($aLineups != null && is_array($aLineups)):?>
                    <?php foreach($aLineups as $aLineup):?>
                        ...
                        <li class="f-roster-position f-count-0 player-position-<?php echo $aLineup['id'];?>" <?php if($aPool['is_round'] == 1):?>style="padding-left: 0;background: none;"<?php endif;?>>
                            <div class="f-player-image" <?php if($aPool['is_round'] == 1):?>style="display: none;"<?php endif;?>></div>
                            <div class="f-position"><?php echo $aLineup['name'];?>
