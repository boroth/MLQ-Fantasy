...
class Fanvictor_Admin
{
    ...
    public static function loadMenuBar()
    {
        ...
        add_submenu_page('', __('Add Sport', FV_DOMAIN), __('Add Sport', FV_DOMAIN), 'manage_options', 'add-sports', array('Fanvictor_Sports', 'addSports'));
        ...
        add_submenu_page('', __('Add Events', FV_DOMAIN), __('Add Events', FV_DOMAIN), 'manage_options', 'add-pools', array('Fanvictor_Pools', 'addPools'));
        ...
        add_submenu_page('', __('Add Contests', FV_DOMAIN), __('Add Contests', FV_DOMAIN), 'manage_options', 'add-contests', array('Fanvictor_Contests', 'addContests'));
        ...
        add_submenu_page('', __('Add Fighters', FV_DOMAIN), __('Add Fighters', FV_DOMAIN), 'manage_options', 'add-fighters', array('Fanvictor_Fighters', 'addFighters'));
        ...
        add_submenu_page('', __('Add Teams', FV_DOMAIN), __('Add Teams', FV_DOMAIN), 'manage_options', 'add-teams', array('Fanvictor_Teams', 'addTeams'));
        
        $hook = add_submenu_page('fanvictor_page', __('Manage Player Positions', FV_DOMAIN), __('Manage Player Positions', FV_DOMAIN), 'manage_options', 'manage-playerposition', array('Fanvictor_PlayerPosition', 'managePlayerPosition'));
        add_action("load-$hook", array('Fanvictor_Admin', "playerposition_screen"));
        add_submenu_page('', __('Add Player Position', FV_DOMAIN), __('Add Player Position', FV_DOMAIN), 'manage_options', 'add-playerposition', array('Fanvictor_PlayerPosition', 'addPlayerPosition'));
        
        $hook = add_submenu_page('fanvictor_page', __('Manage Scoring Categories', FV_DOMAIN), __('Manage Scoring Categories', FV_DOMAIN), 'manage_options', 'manage-scoringcategory', array('Fanvictor_ScoringCategory', 'manageScoringCategory'));
        add_action("load-$hook", array('Fanvictor_Admin', "scoringcategory_screen"));
        add_submenu_page('', __('Add Scoring Category', FV_DOMAIN), __('Add Scoring Category', FV_DOMAIN), 'manage_options', 'add-scoringcategory', array('Fanvictor_ScoringCategory', 'addScoringCategory'));
        ...
        add_submenu_page('', __('Add Players', FV_DOMAIN), __('Add Players', FV_DOMAIN), 'manage_options', 'add-players', array('Fanvictor_Players', 'addPlayers'));
        ...
        add_submenu_page('', __('Add Player News', FV_DOMAIN), __('Add Player News', FV_DOMAIN), 'manage_options', 'add-playernews', array('Fanvictor_PlayerNews', 'addPlayerNews'));
