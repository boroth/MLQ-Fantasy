                            ...
                            startTime == 'all')
                        {
                                ...
                                contestType == 'all')
                            {
                                   ...
                                   leagueSize[0] == 'all')
                                {
                                    ...
                                    {
                                        var btn_enter = '';
                                        if(aLeague.full == 0 || (aLeague.enter && aLeague.multi_entry == 0))
                                        {
                                        ...
                                        else 
                                        {
                                            btn_enter = 
                                                '<div>\n\
                                                    <a href="javascript:void(0)" class="f-button f-really-dangerous f-tiny">Full</a>\n\
                                                </div>';
                                        }
                                        ...
                                        if(no_cash == 0)
                                        {
                                            ...
                                            htmlCash += 
                                                ...
                                                <div class="f-prizes breakdown" style="width: 8%"><span class="ftMobileTitle">PRIZES</span>\n\
                                                    <div onclick="return jQuery.playerdraft.ruleScoring(\'' + aLeague.gameType + '\', ' + aLeague.leagueID + ', \'' + quoteEncoding(aLeague.name) + '\', \'' + aLeague.entry_fee + '\', \'' + aLeague.salary_remaining + '\', 3)">\n\
                                                        $' + aLeague.prizes + '\n\
                                                    </div>\n\
                                                </div>';
                                        }
                                        html +=   
                                            '<div class="f-lobbyitem">\n\
                                                <div class="f-title" style="width: ' + titlewidth + '"><span class="ftMobileTitle">CONTEST</span>\n\
                                                    ' + htmlImage + '\n\
                                                    <a href="#" class="f-title-link" onclick="return jQuery.playerdraft.ruleScoring(\'' + aLeague.gameType + '\', ' + aLeague.leagueID + ', \'' + quoteEncoding(aLeague.name) + '\', \'' + aLeague.entry_fee + '\', \'' + aLeague.salary_remaining + '\',1, \'' + jQuery('#submitUrl').val() + aLeague.leagueID + '\')">' + aLeague.name + '\n\
